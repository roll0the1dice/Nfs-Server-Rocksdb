...
public class RequestChannalHandler {
        ...
        private static class FileUploadSession {
            ...
            public String complete() throws java.io.IOException {
                String filePath = STORAGE_DIR + java.io.File.separator + fileName;
                java.nio.file.Files.write(java.nio.file.Paths.get(filePath), dataBuffer.toString().getBytes());
