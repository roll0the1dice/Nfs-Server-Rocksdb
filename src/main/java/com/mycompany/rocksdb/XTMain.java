...
public class XTMain {
        ...
        private static final Logger logger = LoggerFactory.getLogger(com.mycompany.rocksdb.App.class);

        static {
            RocksDB.loadLibrary();
        }

        private static final String DB_PATH = "/fs-SP0-3/rocks_db"; // 数据库文件存放目录

        //private static final String DB_PATH = "/fs-SP0-8-index/rocks_db";
...
//                        db.put(fileMetaKey.getBytes(StandardCharsets.UTF_8), objectMapper.writeValueAsBytes(fileMetadata));
                        ...
                        //String key = "*4436/12321/README.md" + new String(new byte[]{0}) + "null";
                        //String kkkey = "*4436/12321/testfile" + new String(new byte[]{0}) + "null";
                        String key = "#21638_12321_93a95486409bd21b436a9bfeb3b95a4a925cc5_zYtBubtpsmDCUqL7XiGBpFKsSrtGkvR1";
                        ...
                        if (value != null) {
                            ...
                            //VersionIndexMetadata versionIndexMetadata = objectMapper1.readValue(value, VersionIndexMetadata.class);
                            //versionIndexMetadata.setFileName("/31312_12321_4db7a501f9cc974f281b4649f34d70e567fb66_uyg498HTJFwy4LVayzPQxh0dTbzCcE47");
                            FileMetadata fileMetadata = objectMapper1.readValue(value, FileMetadata.class);
                            fileMetadata.getOffset().set(0, fileOffset);
                            db.put(key.getBytes(StandardCharsets.UTF_8), objectMapper1.writeValueAsBytes(fileMetadata));
